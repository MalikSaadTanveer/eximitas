          ...
          <div className='card-body'>
            ...
            <div className='card-title'>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <div style={{ fontSize: '22.5px' }}>Contacts</div>
                <div className='form-inline'>
                  <NavLink to="" className='button-links' style={{ backgroundColor:'#209FCA',marginRight: '10px' }}>Create New Contact</NavLink>
                  <NavLink to='' className='button-links' style={{ backgroundColor:  '#005D8E'}}>Exports</NavLink>
